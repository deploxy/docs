...
summary: 'A deep dive into the .deploxy.json file and advanced deployment settings.'
sequence: 8
---
...
Deploxy supports a wide range of AWS regions. Some popular choices include:
