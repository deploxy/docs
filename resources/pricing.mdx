...
description: 'Compare the Hobby and Pro plans to choose the one that best fits your needs for MCP operations, global routing, and scalability.'
sequence: 11
keywords: ['pricing', 'plans', 'hobby', 'pro', 'billing', 'cost', 'usage', 'limits']
icon: 'dollar-sign'
---
